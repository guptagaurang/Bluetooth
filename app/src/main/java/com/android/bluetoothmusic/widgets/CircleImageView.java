...
public class CircleImageView extends AppCompatImageView {
    ...
    private CircleImageObserver circleImageObserver;
    ...
    public CircleImageView(Context context, @Nullable AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            highlightColor = a.getColor(R.styleable.CircleImageView_highlightImageColor, DEF_PRESS_HIGHLIGHT_COLOR);
    ...
    public interface CircleImageObserver {
        void click();

        void clicked();
    }

    public void setCircleImageObserver(CircleImageObserver circleImageObserver) {
        this.circleImageObserver = circleImageObserver;
    }
}
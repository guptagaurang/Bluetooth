...
public class EditorView extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        try {
            ...
            editText.setHint(hintEditor);
            editText.setSingleLine();
            editText.setGravity(Gravity.CENTER_VERTICAL);
            editText.setBackgroundColor(Colors.colorTransparent(context));
            editText.setPadding(editorSymmetricPadding, editorSymmetricPadding, editorSymmetricPadding, editorSymmetricPadding);
